...
class Args:
    ...
    path_to_yelp = '/data/zhanghData/Datasets/yelp'
    path_to_sst2 = '/data/zhanghData/AttentionDefense/data/sst2'
    val_split_size = 1000
    if dataset == 'yelp':
        val_split_size = 50000
    pad_token = "<pad>"
    eos_token = "."
    unk_token = "<unk>"
    pre_trained_base = os.path.join("/data/zhanghData/AttentionDefense/data/pretrained/",model_type,dataset)
