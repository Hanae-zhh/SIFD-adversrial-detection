...
def get_detector_info(model_name):
    ...
    mode_= infos[0][-1]
    dim = infos[2].split(".")[0][-1]
    return int(mode_),int(dim)

if __name__ == '__main__':

    ''''''
# CUDA_VISIBLE_DEVICES=6 python3 test_detect.py --dataset imdb  --model_type cnn --attack pwws
# CUDA_VISIBLE_DEVICES=6 python3 test_detect.py --dataset imdb  --model_type lstm --attack pwws
# CUDA_VISIBLE_DEVICES=6 python3 test_detect.py --dataset imdb  --model_type bert --attack pwws
    ...
    de_model_name = 'imdb_bert/deepwordbug_0.1/xgboost/mode3_num3000_dim5.pickle'
    ...
    test_set_dir =  '/data/zhanghData/AttentionDefense/save_results/test_detector'
