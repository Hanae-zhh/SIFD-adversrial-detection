...
if __name__ == '__main__':
    ...
    argparser.add_argument('--detector_type',type=str,default='xgboost')
    ...
    info_dir_path = os.path.join(os.getcwd(),'data/detector_data')
    model_dir = os.path.join(os.getcwd(),'save_models','dettectoe_models')
...
## CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset imdb --data_num 3000 --model_type lstm --detector_type xgboost --score_mode 2 --feat_dim 20 --atk_path deepwordbug_0.1_1500


#-----------------roberta
# CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset agnews --mode 3 --data_num 1000 --model_type roberta --score_mode 2 --feat_dim 5 --atk_path textfooler_0.2_500
# CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset agnews --mode 3 --data_num 1000 --model_type roberta --atk_path pwws_0.2_500 --score_mode 0 --feat_dim 10
# CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset agnews --mode 3 --data_num 1000 --model_type roberta --atk_path bae_0.2_500  --score_mode 0 --feat_dim 15 
# CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset agnews --mode 3 --data_num 1000 --model_type roberta --atk_path deepwordbug_0.2_500  --score_mode 2 --feat_dim 5 


#-----------------bert
# CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset agnews --mode 3 --data_num 1000 --model_type bert --atk_path textfooler_0.2_500 --score_mode 2 --feat_dim 5 
# CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset agnews --mode 3 --data_num 1000 --model_type roberta --score_mode 2 --feat_dim 5 --atk_path pwws_0.2_500
# CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset agnews --mode 3 --data_num 1000 --model_type roberta --score_mode 2 --feat_dim 5 --atk_path bae_0.2_500
# CUDA_VISIBLE_DEVICES=2 python3 train_detector.py --dataset agnews --mode 3 --data_num 1000 --model_type roberta --score_mode 2 --feat_dim 5 --atk_path textfooler_0.2_500
