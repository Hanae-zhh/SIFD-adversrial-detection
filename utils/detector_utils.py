...
def sentence_sensitivity_base_information_nn(
    ...
    for confidence in confidences:
        scores.append(orig_softmax[output_label]-confidence[output_label])
    ...
    return orig_softmax,output_label,sorted_info   
...
def sentence_sensitivity_base_information_bert_grad(
    ...
    sub_scores = (input_embed_grad).sum(axis =-1)
...
def sentence_sensitivity_base_information_nn_grad(
    ...
    output_label =  int(output_label)
    #print("output_label:{}".format(output_label))
    input_scores =  v1.grad.sum(axis =-1)[0]
